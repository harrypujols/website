<!DOCTYPE html>
<?
$lastPage = 3; //indicates the last page in the comic
$shortName = "virginia"; //indicates the name of the folder where the comic is located
$comicName = "Virginia is for Haters";
